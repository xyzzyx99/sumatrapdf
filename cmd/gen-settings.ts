...
const fileSettings: Field[] = [
  ...
  mkField(
    ...
    Str,
    null,
    "chapter/page location in the document, serialized as 'chapter/page' (0-based). If set, takes precedence over PageNo for multi-chapter documents",
  ),
...
const tabState: Field[] = [
  ...
  mkField("PageNo", Int, 1, "number of the last read page"),
  mkField("Location", Str, null, "same as FileStates -> Location"),
