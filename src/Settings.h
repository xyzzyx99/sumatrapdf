...
static const FieldInfo gFileStateFields[] = {
    ...
    {offsetof(FileState, location), SettingType::String, 0},
...
static StructInfo gFileStateInfo = {
    ...
    "o\0Location\0Zoom\0Rotation\0WindowState\0WindowPos\0ShowToc\0SidebarDx\0DisplayR2L\0ReparseIdx\0TocState"};
...
static const FieldInfo gTabStateFields[] = {
    ...
    {offsetof(TabState, location), SettingType::String, 0},
...
static const StructInfo gTabStateInfo = {
    sizeof(TabState), 9, gTabStateFields,
    "FilePath\0DisplayMode\0PageNo\0Location\0Zoom\0Rotation\0ScrollPos\0ShowToc\0TocState"};
